                ...
                <table class="w-full coffee-border rounded-lg shadow-sm">
                    <thead class="coffee-table-header">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider border-b coffee-border">User</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider border-b coffee-border">Total Price</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider border-b coffee-border">Amount Received</th>
                            <th class="px-6 py-3 text-left text-sm font-medium uppercase tracking-wider border-b coffee-border">Change</th>
                    ...
                    <tbody class="divide-y coffee-border">
                        ...
                        <tr class="coffee-table-row">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm coffee-text-primary">
                                <a href="{{ route('admin.orders.show', $order) }}" 
                                   class="coffee-btn-view px-4 py-2 rounded-lg font-medium shadow-sm inline-flex items-center">
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center coffee-empty-state">
                                <div class="flex flex-col items-center justify-center py-8">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#a67c52" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-package mb-2">
