            ...
            <div class="bg-[#F1EADC] text-black min-h-screen transition-all duration-300 shadow-lg"
                ...
                <ul class="mt-4 space-y-2">
                    ...
                    <li class="relative">
                        ...
                        <button @click="manageOpen = !manageOpen" class="flex items-center justify-between w-full p-2 rounded transition-all duration-200 
                            ...
                            <i data-lucide="chevron-down" class="transition-transform duration-200" :class="manageOpen ? 'rotate-180' : ''"></i>
                        </button>
